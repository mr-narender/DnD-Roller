function characterSheetTutorial() {
    ...
    tutorial.setOptions({
        steps: [{
            ...
            intro: "This is one of your <b>Ability Scores</b> for your character, they accept any value from 1 to 30, once clicked off the field they will show the modifier next to their labels."
        }, {
            ...
            intro: "This is one of your <b>Skills</b>, they will update their modifiers once their fields are changed and clicked off."
        }, {
